...
const CalendarioReserva = () => {
  return (
    <div className="flex-wrap h-full w-full flex gap-10 items-center justify-evenly">

      <iframe
          className='h-110 w-100 md:h-110 md:w-1/2 border-4 border-amber-900  rounded-xl'
