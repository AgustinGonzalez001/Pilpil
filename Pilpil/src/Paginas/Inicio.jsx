    ...
    return(
        <>
            <div className=' static'>
                ...
                <div className="md:w-75 md:h-30 font-mono text-lg  bg-[#ffc8007d] rounded-[2vh] absolute md:top-50 top-26 right-20 grid justify-center items-center justify-items-center">
