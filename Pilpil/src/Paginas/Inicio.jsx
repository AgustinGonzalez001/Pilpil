    ...
    return(
        <>
            <div className='w-335 static'>
                ...
                <div className="w-50 h-35 md:w-75 md:h-30 font-mono md:text-lg text-xs  bg-[#ffc8007d] rounded-[2vh] md:absolute md:top-50 md:right-20 absolute top-35 left-150  grid justify-center items-center justify-items-center">
