export default function Lista({props}){
    return(
          ...
          <ul className=" flex flex-wrap items-center justify-center mt-5 gap-10">
                        {props.map((plato)=>(
                            <div className="max-w-65 flex flex-col items-center gap-2 bg-white text-black rounded-lg" key={plato.id}>
                                ...
                                <p className="h-25 p-2 grid justify-items-center">{plato.descripcion}</p>
