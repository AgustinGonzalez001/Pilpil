    ...
    <div className='mr-70'>
      <StyledWrapper>
        <ul className="wrapper">
          ...
          <a className="icon twitter" href='https://laguiaesquel.com/premium/pil-pil/'>
            <span className="tooltip">GuiaEsquel</span>
            <BiSolidMap/>
          </a>
          <a className="icon instagram" href='https://www.instagram.com/pilpilesquel/?hl=es'>
