...
function App() {
  ...
  return (
    <div>
      <nav className='h-20  md:w-335 md:h-25 mb-1 mt-3 gap-30 // flex justify-end items-center md:flex md:justify-between // bg-[#5a2517e3] // rounded-t-lg border-3 border-amber-950'>
        <Link to="/">
