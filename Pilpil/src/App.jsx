...
import LogoPilpil from './assets/LogoPilpil.jpg'

import Page from './PruevaReact.tsx'
import Reservas from './PruevaReact.tsx';
...
function App() {
  ...
  return (
    <div>
      ...
      <div className='h-20 w-auto md:w-335 md:h-22  bg-[#6b210be0]  flex justify-end items-center md:flex md:justify-between   mt-1 gap-2 md:gap-20 rounded-b-lg border-3 border-amber-950'>
        <p className='md:text-lg text-ms text-center md:font-serif ml-5'>Direccion: <a href="https://www.google.com.ar/maps/place/PilPil+-+Sabores+de+la+Patagonia/@-42.9122924,-71.3217581,18.5z/data=!4m6!3m5!1s0x961dac39f2f388bf:0x95ae6fc966783ec4!8m2!3d-42.9119874!4d-71.3214166!16s%2Fg%2F11hbnf5cm5?hl=es&entry=ttu&g_ep=EgoyMDI1MDUyOC4wIKXMDSoASAFQAw%3D%3D">Sarmiento 799, Esquel, Chubut </a></p>
