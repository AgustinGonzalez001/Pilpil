...
import Calendario from './Paginas/Reservacion.jsx'

function App() {

  return (
    <>
      <nav className='w-screen h-22 mb-1 // md:flex  justify-between items-center // bg-[#5a2517] // rounded-t-lg border-3 border-amber-950'>
        <Link to="/">
          <img className='md:w-35 md:h-20 w-14 h-8 ml-2 rounded-full border-2 border-solid border-[#260c05]'
        ...
        <ul className='justify-items-stretch flex md:mr-30 gap-10 text-xl text-[#ff8400c7] underline decoration-wavy '>
      ...
      <div className=' h-22  bg-[#6b210be0]  md:flex justify-center items-center  mt-1 gap-2 rounded-b-lg border-3 border-amber-950'>
