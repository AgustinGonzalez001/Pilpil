...
function App() {
  ...
  return (
    <div className='h-300'>
      ...
      <div className='w-full md:h-30 h-20 bg-[#6b210be0] flex justify-end content-start md:flex md:justify-between mt-5 gap-2 md:gap-20 box-content border-3 border-amber-950'>
